...
class RelationExtraction:
    ...
    def tag_relations(self, pre_tagged_sentence: TaggedSentence) -> TaggedSentence:
        ...
        entities = pre_tagged_sentence.get_tagged_ngrams_as_string(["ITEM", "ACTIVITY"]) # todo: remove hardcoding
        pre_tagged_sentence.relations = self.tagger.tag_relations(text, entities)
        ngrams = pre_tagged_sentence.get_ngrams_with_tags(["ITEM", "ACTIVITY"])
